...
from .centerpoint_bbox_coders import CenterPointBBoxCoder, CenterPointParkingspotBBoxCoder
...
__all__ = [
    ...
    'CenterPointBBoxCoder', 'AnchorFreeBBoxCoder', 'GroupFree3DBBoxCoder', 'CenterPointParkingspotBBoxCoder'
]
